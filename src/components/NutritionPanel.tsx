    ...
    const fetchAnalysis = async () => {
      ...
      try {
        ...
        setAnalysis(
          ...
          `_AI analysis temporarily unavailable. These are general nutrition facts._`
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="animate-slide-up">
      <div className="grocery-card mb-4">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-8 gap-2 text-muted-foreground">
            ...
            <span className="font-body">Analyzing nutritional content...</span>
          </div>
        ) : (
      ...
      <div className="text-center">
        <Button variant="hero" size="lg" className="rounded-2xl px-8" onClick={onContinue}>
